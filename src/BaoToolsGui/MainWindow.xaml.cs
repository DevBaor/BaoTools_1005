...
public partial class MainWindow : Wpf.Ui.Controls.FluentWindow
{
    ...
    {
        _trayIcon = new System.Windows.Forms.NotifyIcon { Text = "BaoTools", Visible = false };
        try
        {
        ...
        menu.Items.Add(BaoToolsGui.Resources.Strings.Tray_Open, null, (_, _) => RestoreFromTray());
        menu.Items.Add(new System.Windows.Forms.ToolStripSeparator());
        menu.Items.Add(BaoToolsGui.Resources.Strings.Tray_Exit, null, (_, _) => ExitApp());
    ...
    /// <summary>Launch tray-only for a headless install (baotools://install/silent/&lt;id&gt;): show the tray
