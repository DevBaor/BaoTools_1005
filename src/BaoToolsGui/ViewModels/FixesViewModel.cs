...
{
    private readonly BaoToolsApiClient api;
    ...
    public FixesViewModel(
        BaoToolsApiClient api, AuthService auth, CoverCache covers, ToastService toast,
    ...
    /// Used by the baotools://fix/ protocol handler.
    /// </summary>
