...
/// %AppData%\BaoToolsGui\depotdownloader, mirroring <see cref="SteamlessService"/>.
/// </summary>
/// <remarks>
    ...
    ILogger<DepotDownloaderService> log)
{
    ...
    private static readonly string ToolDir = Path.Combine(
        Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "BaoToolsGui", "depotdownloader");
    ...
    /// <summary>
    /// Depot-id to decryption key for an app: from its installed lua first (that's where BaoTools puts
