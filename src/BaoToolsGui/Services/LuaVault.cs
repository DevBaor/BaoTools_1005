...
/// <code>
/// %AppData%\BaoToolsGui\luavault\&lt;appid&gt;\index.json
/// %AppData%\BaoToolsGui\luavault\&lt;appid&gt;\&lt;sha256&gt;.lua
/// </code>
...
public class LuaVault
{
    private static readonly string DefaultRoot = Path.Combine(
        Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "BaoToolsGui", "luavault");
