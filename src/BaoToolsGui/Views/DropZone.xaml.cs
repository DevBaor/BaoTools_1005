...
public partial class DropZone : UserControl
{
    ...
    private async void OnDrop(object sender, DragEventArgs e)
    {
        ...
        // A dragged SteamDB / Steam link → install that appid, same as baotools://install/<id>.
    ...
    private async void OnBrowseClick(object sender, RoutedEventArgs e)
    {
        ...
        {
            Title = BaoToolsGui.Resources.Strings.Drop_Picker_Title,
            Multiselect = true,
            Filter = BaoToolsGui.Resources.Strings.Drop_Picker_Filter,
        };
